...
public partial class PizzariaContext : DbContext
{
    ...
    public virtual DbSet<PizzaSabores> _PizzaSabores { get; set; }

    public virtual DbSet<Sabores> _Sabores { get; set; }

    public virtual DbSet<StatusPizza> StatusPizzas { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-43ORG2R\\SQLEXPRESS;Database=Pizzaria;User ID=sa;Password=220202;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PizzaSabores>(entity =>
        {
